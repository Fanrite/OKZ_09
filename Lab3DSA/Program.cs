...
namespace Lab3DSA
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int q;
            Random rdm = new Random(); q = rdm.Next(10, 100);
            ...
            while (true)
            {
                ...
                if (r != 0 || s != 0)
                {
                    Console.WriteLine("Пвідомлення з підписом: [{0}, {1}, {2}]", M, r, s);
                    break;
                }
            }
            
            Console.Write("Перевірка підпису, введіть повідомлення:");
                M = Console.ReadLine();
                int s1 = 0;
                while ((s1 * s) % q != 1)
                {
                ...
                if (v == r)
                {
                    Console.WriteLine("Підпис вірний: {0} = {1}", v, r);
                }
